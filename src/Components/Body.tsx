...
//             C
//           </div>
//           <div id="plus-minus" onClick={() => this.handlePlusMinus()}>
//             +/-
//           </div>
//           <div id="percent" onClick={() => this.handlePercent()}>
//             %
//           </div>
//           <div id="divide" onClick={() => this.handleOperation("/")}>
//             ÷
//           </div>
...
//             9
//           </div>
//           <div id="multiply" onClick={() => this.handleOperation("x")}>
//             x
//           </div>
...
//             6
//           </div>
//           <div id="subtract" onClick={() => this.handleOperation("-")}>
//             -
//           </div>
...
//             3
//           </div>
//           <div id="add" onClick={() => this.handleOperation("+")}>
//             +
//           </div>
//           <div id="zero" onClick={() => this.handleNumber("0")}>
//             0
//           </div>
//           <div id="decimal" onClick={() => this.handleDot()}>
//             .
//           </div>
